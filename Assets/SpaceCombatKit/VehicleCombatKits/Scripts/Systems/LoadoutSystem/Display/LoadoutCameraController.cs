...
namespace VSX.UniversalVehicleCombat.Loadout
{
	...
	public class LoadoutCameraController : MonoBehaviour
    {
        ...
        [SerializeField]
        protected Vector3 vehicleViewportPosition = new Vector3(0.5f, 0.5f, 0.0f);
        ...
        [SerializeField]
        protected Vector3 moduleViewportPosition = new Vector3(0.5f, 0.5f, 0.0f);
        ...
        protected virtual void VehicleFocusUpdate()
        {
            ...
            {
                Vector3 offset = new Vector3(-15f, 0f, 0f); // Adjust -2f to move more or less to the left
                viewRotationGimbal.transform.position = vehicle.transform.TransformPoint(vehicle.Bounds.center + offset);
            }
        ...
        protected virtual Vector3 ViewportPositionAdjustment(float distance, Vector3 viewportPosition)
        {
            ...
            offset += Vector3.forward * viewportPosition.z;
        ...
        public Camera setCamera1;
        public Camera setCamera2;

        void Start()
        {
            // Ensure only one camera is active at the start
            SetCamera1(); // You can change this to SetCamera2() if you want Camera2 to start as active
        }

        public void SetCamera1()
        {
            setCamera1.enabled = true;
            setCamera2.enabled = false;
        }

        public void SetCamera2()
        {
            setCamera1.enabled = false;
            setCamera2.enabled = true;
        }
